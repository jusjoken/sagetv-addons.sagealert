 ...
 */
final class RemoteInfoEvent implements SageEvent {
	/**
	 * The metadata for this event.
	 */
	static final SageEventMetaData EVENT_METADATA = new SageEventMetaData(RemoteInfoEvent.class.getCanonicalName(), "Remote Info Alerts", "An info alert triggered by a remote application via the SageAlert XML-RPC server.");
	
	private String title;
	private String desc;
	private String source;
	
	RemoteInfoEvent(String title, String desc, String source) {
		this.title = title;
		this.desc = desc;
		this.source = source;
	}
