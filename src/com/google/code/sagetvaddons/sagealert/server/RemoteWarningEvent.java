 ...
 * @author dbattams
 * @version $Id: RemoteEvent.java 601 2009-10-03 03:53:45Z derek@battams.ca $
 */
final class RemoteWarningEvent implements SageEvent {
	/**
	 * The metadata for this event.
	 */
	static final SageEventMetaData EVENT_METADATA = new SageEventMetaData(RemoteWarningEvent.class.getCanonicalName(), "Remote Warning Alerts", "A warning alert triggered by a remote application via the SageAlert XML-RPC server.");
	
	private String title;
	private String desc;
	private String source;
	
	RemoteWarningEvent(String title, String desc, String source) {
		this.title = title;
		this.desc = desc;
		this.source = source;
	}
