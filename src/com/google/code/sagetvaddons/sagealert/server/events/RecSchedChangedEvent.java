 ...
 *
 */
public final class RecSchedChangedEvent extends NoArgEvent {
	
	public RecSchedChangedEvent(SageAlertEventMetadata data) {
		super(data);
	}
	...
	public String getSource() {
		return CoreEventsManager.REC_SCHED_CHANGED;
	}
}
