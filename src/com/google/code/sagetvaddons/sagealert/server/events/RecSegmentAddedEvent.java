 ...
 *
 */
public class RecSegmentAddedEvent extends RecordingEvent {

	/**
	 * @param mf
	 * @param data
	 */
	public RecSegmentAddedEvent(MediaFile mf, SageAlertEventMetadata data) {
		super(mf, data);
	...
	public String getSource() {
		return CoreEventsManager.REC_SEG_ADDED;
	}
