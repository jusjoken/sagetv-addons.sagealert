 ...
 *
 */
public class PlaylistModifiedEvent extends PlaylistEvent {
	 ...
	 * @param data
	 */
	public PlaylistModifiedEvent(Playlist playlist, Client clnt,
			SageAlertEventMetadata data) {
		super(playlist, clnt, data);
		// TODO Auto-generated constructor stub
	}

	/* (non-Javadoc)
	 * @see com.google.code.sagetvaddons.sagealert.server.events.PlaylistEvent#getSource()
	 */
	@Override
	public String getSource() {
		return CoreEventsManager.PLAYLIST_MODDED;
	}
