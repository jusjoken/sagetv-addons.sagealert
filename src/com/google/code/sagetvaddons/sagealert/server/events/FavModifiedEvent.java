 ...
 *
 */
public class FavModifiedEvent extends FavEvent {

	/**
	 * @param fav
	 * @param data
	 */
	public FavModifiedEvent(Favorite fav, SageAlertEventMetadata data) {
		super(fav, data);
		// TODO Auto-generated constructor stub
	}

	/* (non-Javadoc)
	 * @see com.google.code.sagetvaddons.sagealert.server.events.FavEvent#getSource()
	 */
	@Override
	public String getSource() {
		return CoreEventsManager.FAV_MODDED;
	}
