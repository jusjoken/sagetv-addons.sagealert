 ...
 *
 */
public class MediaFileImportedEvent extends MediaFileEvent {

	/**
	 * @param mf
	 * @param data
	 */
	public MediaFileImportedEvent(MediaFile mf, SageAlertEventMetadata data) {
		super(mf, data);
		// TODO Auto-generated constructor stub
	}

	/* (non-Javadoc)
	 * @see com.google.code.sagetvaddons.sagealert.server.events.MediaFileEvent#getSource()
	 */
	@Override
	public String getSource() {
		return CoreEventsManager.MEDIA_FILE_IMPORTED;
	}
