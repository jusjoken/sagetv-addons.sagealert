 ...
 *
 */
public class ImportCompletedEvent implements SageAlertEvent {
	static public final String[] ARG_TYPES = new String[] {Boolean.class.getName() + " (full reindex)"};
	 ...
	 * 
	 */
	public ImportCompletedEvent(boolean fullReindex, SageAlertEventMetadata data) {
		this.fullReindex = fullReindex;
		metadata = data;
		args = new Object[] {fullReindex};
	}
	...
	public String getSource() {
		return CoreEventsManager.IMPORT_COMPLETED;
	}
