 ...
 *
 */
public class SystemMessageInfoEvent extends SystemMessageEvent {

	public SystemMessageInfoEvent(SystemMessage msg, SageAlertEventMetadata data) {
		super(msg, data);
	}

	@Override
	public String getSource() {
		return CoreEventsManager.INFO_SYSMSG_POSTED;
	}
