 ...
 *
 */
public abstract class MediaFileEvent implements SageAlertEvent {
	static public final List<String> ARG_TYPES = Arrays.asList(MediaFileAPI.MediaFile.class.getName());
	 ...
	 * 
	 */
	public MediaFileEvent(MediaFileAPI.MediaFile mf, SageAlertEventMetadata data) {
		this.mf = mf;
		metadata = data;
		args = new Object[] {this.mf};
	}
